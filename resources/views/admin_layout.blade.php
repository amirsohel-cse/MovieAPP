        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    <li>
                        <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Movies</span></a>
                        <ul>
                            <li><a class="submenu" href="{{URL:: to('/add_movie')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Movie</span></a></li>
                            <li><a class="submenu" href="{{URL:: to('/all_movie')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Movie</span></a></li>
